...
import TextInput from "../JobPost/TextInput";
import CustomButton from "../JobPost/CustomButton";

const Footer = () => {
  return (
    <footer className='text-white mp-10 text-xl'>
      ...
      <div className='bg-[#1d4ed8] '>
          ...
          <div className='w-full flex flex-wrap gap-10 justify-between -mb-10 -px-4'>
            {footerLinks.map(({ id, title, links }) => (
              <div className='w-auto px-4 ' key={id + title}>
                <h2 className='font-medium text-white tracking-widest text-xl mb-2'>
                  {title}
                </h2>
        ...
        <div className=''>
          <p className='container px-5 mx-auto text-white mt-2 '>
            Subscribe to our Newsletter - NiceJob
          </p>

          <div className='container mx-auto px-5  pb-5 flex flex-wrap items-center justify-between '>
            <div className='w-full md:w-2/4 lg:w-1/3 h-16 flex items-center justify-center md:justify-start '>
              ...
              <CustomButton
                title='Subscribe'
                containerStyles={
                  "block bg-[#001a36] text-white px-5 py-2 text-md rounded hover:bg-blue-600 focus:potline-none flex-col items-center mt-2"
                }
              />
            </div>
        ...
        <div className='bg-[#001a36]'>
          <div className='container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row'>
            <p className='text-gray-300 text-sm text-center sm:text-left'>
              &copy; 2024 NiceJob — Design By
              <a
                href='https://github.com/BK-KAVIYA'
